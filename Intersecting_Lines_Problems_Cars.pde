...
void setup() {
  ...
  noStroke();
  fill(0, 0, 255);
  ellipse(100 * X_AXIS_SCALE_FACTOR, BRAMPTON_RENT_CAR_COST_100 * Y_AXIS_SCALE_FACTOR, 8, 8);
  ellipse(350 * X_AXIS_SCALE_FACTOR, BRAMPTON_RENT_CAR_COST_350 * Y_AXIS_SCALE_FACTOR, 8, 8);
